...
urlpatterns = [
    ...
    path(
        "requests/pending/",
        views.PendingReceivedRequestsView.as_view(),
        name="pending-received",
    ),
    path(
        "requests/sent/",
        views.PendingSentRequestsView.as_view(),
        name="pending-sent",
    ),
]
